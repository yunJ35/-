...
public class AlterResultInfoDialog extends JDialog implements SwingConstants {
	...
	public AlterResultInfoDialog(JFrame f) {
		super(f, " 修改成绩信息", true);
		...
		btnOK.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				DButils.updateResultInfo(newResultInfo);
				lblMsg.setText("成绩信息修改成功");
			}
		});
