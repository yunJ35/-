...
public class EntryRecordDialog extends JDialog implements SwingConstants {
	JPanel p;
	JLabel[] label;
	JLabel lblMsg;
	...
	public EntryRecordDialog(JFrame f) {
		super(f, " 录入成绩", true);
			...
			public void actionPerformed(ActionEvent e) {
				if (classCourse.getSemester().equals("选择学期")) {
					...
					try {
						...
						DButils.insertResult(resultInfo);
						lblMsg.setText("成绩录入成功");
					} catch (Exception e2) {
						lblMsg.setText("成绩录入失败，请重新录入");
					}
				}
