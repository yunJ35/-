...
public class AlterExamInfoDialog extends JDialog implements SwingConstants {
	...
	public AlterExamInfoDialog(JFrame f) {
		super(f, " 修改考试信息", true);
		...
		btnOK.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				DButils.updateClassCourse(newClassCourse);
				lblMsg.setText("考试信息修改成功");
			}
		});
